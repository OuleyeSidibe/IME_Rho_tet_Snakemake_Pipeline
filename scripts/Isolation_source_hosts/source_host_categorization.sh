...
./collect_sourcehost_forall > sourcehost.out 2> missing_assemblies.out

# 2. categorize according to identified keywords
cat sourcehost.out| ./categorize > sourcehost.categorized.out
...
# 2. categorize according to identified keywords
cat IME_Rho_tet_sourcehost.out| ./categorize > IME_Rho_tet_sourcehost.categorized.out
...
# 2. categorize according to identified keywords
cat tet_sourcehost.out| ./categorize > tet_sourcehost.categorized.out
