...
def process_files():
    ...
    try:
        with open("RefseqFINAL3.csv", newline='') as csvfile, open("parse_outTet3.csv", "a") as parse_out:
            ...
            for row in csv_reader:
                ...
                acc_filename = f"/work_projet/isp-pgba/ouleye/PPR_MGEproject/fimo/results_Tet3/{ACC}.tsv"
